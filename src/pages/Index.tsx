...
const Index = () => {
  ...
  const exportToPNG = async () => {
    ...
    try {
      toast.info('Gerando imagem PNG... Isso pode levar alguns segundos.');
  ...
  return (
    <div className={`min-h-screen p-6 transition-colors ${darkBackground ? 'bg-black' : 'bg-background'}`}>
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className={`mt-1 ${darkBackground ? 'text-gray-300' : 'text-muted-foreground'}`}>
          ...
          <div className="flex gap-2">
            ...
            >
              ...
              {darkBackground ? 'Fundo Claro' : 'Fundo Preto'}
            </Button>
            <Button 
              onClick={() => {
        ...
        {/* Dashboard Content - Wrapped for PNG export */}
